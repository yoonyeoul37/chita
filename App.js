...
function CommunityTabScreen() {
  return (
    <CommunityStack.Navigator screenOptions={{ headerShown:false }}>
      ...
      <CommunityStack.Screen name="글수정"       component={EditPostScreen} />
      <CommunityStack.Screen name="로그인"       component={LoginScreen} />
      <CommunityStack.Screen name="회원가입"     component={SignUpScreen} />
